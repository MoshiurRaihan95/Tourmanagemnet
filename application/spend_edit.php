                        ...
                        <form class="spend_form">
                            <div class="row">
                                <div class="form-group  col-lg-4 col-lg-offset-2">
                                    ...
                                    <textarea class="form-control">Bus,Breakfast,Dinner</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group  col-lg-4 col-lg-offset-2">
                                    <label for="name">Related Member</label>
                                    <textarea class="form-control">Raihan, Mamun sarower</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group  col-lg-2 col-lg-offset-2">
                                    <label for="date">Date</label>
                                    <input type="email" class="form-control datepicker" id="date" placeholder="20/10/2016">
                                </div>
                                <div class="form-group  col-lg-2">
                                    <label for="time">Time</label>
                                    <input type="email" class="form-control" id="time" placeholder="3.00PM">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-lg-2 col-lg-offset-2">
                                    <label for="amount">Amount</label>
                                    <input type="email" class="form-control" id="amount" placeholder="4000/Tk">
                                </div>
                                <div class="form-group col-lg-2">
                                    <label>&nbsp;</label><br/>
